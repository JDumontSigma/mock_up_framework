...
function Table_Generator() {
   ...
   for (var i = 0; i < rowCount; i++) {
      detail += '<tr>';
      for (var _x = 0; _x < columnTitle.length; _x++) {
         detail += '<td contenteditable class="item column' + _x + ' ' + columnTitle[_x] + ' " id="' + _x + '">' + Math.floor(Math.random() * 10) + '</td>';
      }
      detail += '</tr>';
   }
   ...
   for (var _i2 = 0; _i2 < columnTitle.length; _i2++) {
      detail += '<option value="' + columnTitle[_i2] + '">' + columnTitle[_i2] + '</option>';
   }
   detail += '</select>';
